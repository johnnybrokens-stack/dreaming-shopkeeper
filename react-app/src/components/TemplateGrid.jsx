        ...
        return (
          <button
            ...
            className={`
              ...
              ${isActive
                ? 'border-[#22c55e] scale-105 bg-white/10 shadow-lg shadow-green-500/20'
                : 'border-white/5 opacity-50 grayscale hover:opacity-80 hover:grayscale-[0.5] hover:border-white/20'
              }
            `}
          >
            {isActive && (
              <span className="absolute -top-2.5 px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-[#22c55e] text-white shadow">
                Active
              </span>
            )}
            ...
            <div
              ...
              style={{ background: isActive ? `${t.themeColor}22` : 'rgba(255,255,255,0.05)' }}
            >
